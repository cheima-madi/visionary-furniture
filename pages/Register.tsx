    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-[2rem] shadow-2xl p-10 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium">Join the Visionary AR community</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <Link to="/login" className="text-indigo-600 font-bold hover:underline">Log in &rarr;</Link>
          </p>
        </div>
      </div>
    </div>
